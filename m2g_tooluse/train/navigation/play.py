...
"""Local RSL-RL play/export wrapper for the Go2+Piper velocity task."""
...
DEFAULT_TASK = "M2G-Navigation-Go2Piper-Velocity-Flat-Play-v0"
...
OFFICIAL_PLAY = OFFICIAL_RSL_RL_DIR / "play.py"
...
def main() -> None:
    ...
    runpy.run_path(str(OFFICIAL_PLAY), run_name="__main__")
